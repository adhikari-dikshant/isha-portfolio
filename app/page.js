        ...
        <div className="page home-page">
            ...
            <section className="hero">
                ...
                <div className="hero-footer">
                    ...
                    <div className="hero-footer-scroll-down">
                        <p className="mn">Backend by Dikshant / <span className="year">{year}</span></p>
                    </div>
                    <div className="hero-footer-tags">
                        <p className="mn">APIs &amp; data: ON</p>
                    </div>
                </div>
            </section>
            ...
            <section className="featured-work">
                ...
                <div className="featured-titles">
                    <div className="featured-title-wrapper">
                        <h1 className="featured-title">Build log</h1>
                    </div>
                    <div className="featured-title-wrapper">
                        <div className="featured-title-img">
                            <img src="/images/work-items/work-item-1.jpg" alt="" />
                        </div>
                        <h1 className="featured-title">Ledger API</h1>
                    </div>
                    <div className="featured-title-wrapper">
                        <div className="featured-title-img">
                            <img src="/images/work-items/work-item-2.jpg" alt="" />
                        </div>
                        <h1 className="featured-title">Auth gateway</h1>
                    </div>
                    <div className="featured-title-wrapper">
                        <div className="featured-title-img">
                            <img src="/images/work-items/work-item-3.jpg" alt="" />
                        </div>
                        <h1 className="featured-title">Room 404</h1>
                    </div>
                    <div className="featured-title-wrapper">
                        <div className="featured-title-img">
                            <img src="/images/work-items/work-item-4.jpg" alt="" />
                        </div>
                        <h1 className="featured-title">Event pipeline</h1>
                    </div>
                </div>
                <div className="featured-work-indicator"></div>
                <div className="featured-work-footer">
                    <p className="mn">Project index [ 10 ]</p>
                    <p className="mn">///////////////////</p>
                    <p className="mn">
                        <TransitionLink href="/work">See all work</TransitionLink>
                    </p>
                </div>
            </section>
            ...
            <section className="services-header">
                <div className="services-header-content">
                    ...
                    <p>Your product. Solid under the hood.</p>
                    <div className="services-header-title">
                        <h1>Backend systems</h1>
                        <h1>built to last</h1>
                    </div>
            ...
            <section className="services">
                <div className="service-card" id="service-card-1">
                    <div className="service-card-inner">
                        ...
                        <div className="service-card-img">
                            <img src="/images/services/service-1.jpg" alt="API design" />
                        </div>
                    </div>
                </div>
                <div className="service-card" id="service-card-2">
                    <div className="service-card-inner">
                        <div className="service-card-content">
                            <h1>Data &amp; databases</h1>
                        </div>
                        <div className="service-card-img">
                            <img src="/images/services/service-2.jpg" alt="Database design" />
                        </div>
                    </div>
                </div>
                <div className="service-card" id="service-card-3">
                    <div className="service-card-inner">
                        ...
                        <div className="service-card-img">
                            <img src="/images/services/service-3.jpg" alt="Cloud infrastructure" />
                        </div>
                    </div>
                </div>
                <div className="service-card" id="service-card-4">
                    <div className="service-card-inner">
                        <div className="service-card-content">
                            <h1>Scale &amp; reliability</h1>
                        </div>
                        <div className="service-card-img">
                            <img src="/images/services/service-4.jpg" alt="Performance and scaling" />
                        </div>
                    </div>
                </div>
            </section>
